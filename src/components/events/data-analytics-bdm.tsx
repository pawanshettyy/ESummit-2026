...
import { Circle, ChevronDown, Mail, MapPin, Clock, Calendar, TrendingUp, Award, Target, BarChart2, PieChart, LineChart } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <h1 className="font-bold mb-6 tracking-tight leading-tight">
              <span className="data-bdm-title block pb-6 text-6xl md:text-8xl">
                {title}
              </span>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-white/70 max-w-2xl mx-auto">
            Practical skills to transform data into business growth
          </p>
        </motion.div>
  ...
  const features = [
    {
      ...
      description: "Master the art of storytelling with data using modern visualization tools",
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&auto=format&fit=crop",
    },
    {
      icon: TrendingUp,
      title: "Growth Metrics",
      description: "Learn to track and optimize key metrics like CAC, LTV, and Churn",
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&auto=format&fit=crop",
    },
    {
      icon: PieChart,
      title: "Market Analysis",
      description: "Use data to identify market trends and customer segments",
    ...
    <section id="topics" className="w-full py-20 bg-red-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-white/70 max-w-2xl mx-auto">
            Comprehensive curriculum merging data science with business strategy
          </p>
        </div>
    ...
    <section className="w-full py-20 bg-gradient-to-b from-red-900 to-red-950">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-white/70 max-w-2xl mx-auto">
            Learn from industry experts who have scaled startups using data
          </p>
        </motion.div>
...
export function DataAnalyticsBdmPage() {
  const speakers: Speaker[] = [
    {
      ...
      bio: "10+ years experience in predictive analytics and data-driven business strategy.",
    },
    {
      name: "Rahul Verma",
      role: "Head of Growth, StartupX",
      photo: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&auto=format&fit=crop",
      bio: "Scaled three startups from 0 to 1M users using data analytics and BDM frameworks.",
    },
  ];
  ...
  const topics = [
    ...
    "Types of analytics",
    "Basics of dashboards & KPIs",
    "Decision-making frameworks",
    "Understanding analytics",
    "Reading trends & insights",
    "Making data-backed decisions",
    "Resume-ready mini project",
  ...
  const faqs = [
    {
      ...
      answer: "This workshop is designed for students, aspiring entrepreneurs, and professionals who want to leverage data analytics for business growth. No prior coding experience is required.",
    },
    {
      question: "What software will we use?",
      answer: "We will use industry-standard tools like Tableau (Public), Excel, and introduce basic SQL concepts. All software used will be accessible or free versions.",
    },
    {
      question: "Do I need to bring my own laptop?",
      answer: "Yes, a laptop is required to participate in the hands-on exercises. Please ensure it is fully charged.",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-red-950">
      <HeroSection
        ...
        tagline="Decode Data. Drive Decisions."
        subtitle="Workshop 2026"
        date="January 23-24, 2026"
        time="10:00 AM - 1:00 PM"
        venue="Lab 526 & 527, TCET"
      />
      <ProofSection stats={proofStats} />
      <FeaturesSection 
        topics={topics}
        perks={perks}
        activity="Analyze a dataset → Build insights → Present decisions"
      />
