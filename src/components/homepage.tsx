            ...
            >
              <Card className="overflow-hidden border-primary/10">
                <CardContent className="p-6">
                  ...
                  {/* Fallback Instagram Feed */}
                  <div className="min-h-[400px] flex items-center justify-center bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-950/20 dark:to-purple-950/20 rounded-lg">
                    <div className="text-center max-w-md">
                      ...
                      <p className="text-muted-foreground mb-4">
                        Stay updated with the latest E-Summit news, behind-the-scenes content, and startup stories.
                      </p>
                      <a
                        href="https://instagram.com/esummit_tcet"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white px-6 py-2 rounded-lg hover:from-pink-600 hover:to-purple-600 transition-all"
                      >
